        ...
        try (PreparedStatement stmt = conn.prepareStatement(query)) {
            ...
            while (rs.next()) {
                User user = new User(
                        ...
                        rs.getString("nom"),
                        rs.getString("prenom"),
                        tn.esprit.models.role_user.valueOf(rs.getString("role")),  // Fetch the role
                        rs.getBoolean("verified"),  // Fetch the verified status
                        rs.getString("adresse"),
                        tn.esprit.models.type_vehicule.valueOf(rs.getString("type_vehicule")),  // Fetch the vehicle type
                        rs.getString("email"),
                        rs.getString("password"),
                        rs.getString("num_tel"),
                        rs.getString("cin")
