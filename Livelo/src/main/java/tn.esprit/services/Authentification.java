...
import tn.esprit.interfaces.IServiceAuth;
            ...
            if (rs.next()) {
                ...
                if (BCrypt.checkpw(password, hashedPassword)) {
                    ...
                    User user = new User(
                            ...
                            rs.getString("nom"),
                            rs.getString("prenom"),
                            tn.esprit.models.role_user.valueOf(rs.getString("role")),
                            rs.getBoolean("verified"), // verified field
                            rs.getString("adresse"),
                            tn.esprit.models.type_vehicule.valueOf(rs.getString("type_vehicule")), // type_vehicule field
                            rs.getString("email"),
